     ...
     <h2 className="text-gray sm:text-4xl text-3xl mb-1 font-medium title-font flex justify-center content-center items-center font-mono" 
      ...
      <div className="mb-3 pt-0">
        <input
          ...
          name="name"
          className="px-3 py-3 placeholder-gray-400 text-gray-600 relative bg-whiterounded text-sm border-0 shadow outline-none focus:outline-none focus:ring w-full"
          required
        />
      </div>
      <div className="mb-3 pt-0">
